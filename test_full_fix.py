...
def test_full_integration():
    ...
    try:
        ...
        if school_info:
            ...
            print()
            print(f"Elementary: {school_info.elementary.name}")
            print(f"  CCRPI: {school_info.elementary.ccrpi_score}/100")
            print()
            print(f"Middle: {school_info.middle.name}")
            print(f"  CCRPI: {school_info.middle.ccrpi_score}/100")
            print()
            print(f"High: {school_info.high.name}")
            print(f"  CCRPI: {school_info.high.ccrpi_score}/100")
            print()
        else:
